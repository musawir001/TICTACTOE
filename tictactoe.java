...
public class tictactoe {
    ...
    JLabel scoreLabelX = new JLabel("PLAYER X: " + scoreX);
    JLabel scoreLabelO = new JLabel("PLAYER O: " + scoreO);
    ...
    tictactoe() {
        ...
        scoreLabelX.setFont(new Font("serif", Font.BOLD, 20));
        scoreLabelO.setFont(new Font("serif", Font.BOLD, 20));
    ...
    void highlightWinningEntries(String player) {
        ...
        for (int r = 0; r < 3; r++) {
            if (!board[r][0].getText().isEmpty() &&
                ...
                for (int c = 0; c < 3; c++) {
                    board[r][c].setBackground(Color.GRAY); // Highlight winning entries
                }
                return;
            }
        }
        ...
        if (!board[0][0].getText().isEmpty() &&
            ...
            for (int i = 0; i < 3; i++) {
                board[i][i].setBackground(Color.gray); // Highlight winning entries
            }
            return;
        }
        ...
        if (!board[0][2].getText().isEmpty() &&
            ...
            for (int i = 0; i < 3; i++) {
                board[i][2 - i].setBackground(Color.gray); // Highlight winning entries
            }
            return;
        }
    }
